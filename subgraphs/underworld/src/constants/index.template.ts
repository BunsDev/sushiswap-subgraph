...
export const COFFINBOX_ADDRESS = Address.fromString('{{ coffinbox.address }}')

export const UNDERWORLD_MEDIUM_RISK_MASTER_CONTRACT_ADDRESSES = '{{ underworld.mediumRiskMasterContractAddresses }}'.split(',')
...
export const ACTIONS: UnderworldActions = {
