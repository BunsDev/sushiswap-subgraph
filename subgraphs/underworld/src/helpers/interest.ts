...
export function getInterestPerYear(
  totalBorrow: BigInt,
  ...
  if (utilization < MINIMUM_TARGET_UTILIZATION) {
    ...
    const overFactor = utilization
      .minus(MAXIMUM_TARGET_UTILIZATION)
